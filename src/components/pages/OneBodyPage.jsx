...
export default function OneBodyPage({ body }) {
  const counHandler = (e) => {
    ...
    axios.patch(`/api/count/${body.id}`)
      .then(() => localStorage.setItem(`${body.id}`, body.id));
  };
    ...
    <div className="card" style={{ width: '18rem' }}>
      ...
      <div className="card-body">
        ...
        <i className="bi bi-hand-thumbs-up">
          <button type="button" className="btn btn-outline-primary disabled" disabled={!!localStorage[body.id]} onClick={counHandler}>
            {' '}
